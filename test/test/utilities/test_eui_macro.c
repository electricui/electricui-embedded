...
eui_message_t expected_object_array[] = {
    ...
    { .id = "int16",  .type = TYPE_INT16,    .size = 2,  {.data = &macro_int16}    },
    { .id = "int32",  .type = TYPE_INT32,    .size = 4,  {.data = &macro_int32}    },
    { .id = "uint8",  .type = TYPE_UINT8,    .size = 1,  {.data = &macro_uint8}    },
    { .id = "uint16", .type = TYPE_UINT16,   .size = 2,  {.data = &macro_uint16}   },
    { .id = "uint32", .type = TYPE_UINT32,   .size = 4,  {.data = &macro_uint32}   },
    { .id = "float",  .type = TYPE_FLOAT,    .size = 4,  {.data = &macro_float}    },
    { .id = "double", .type = TYPE_DOUBLE,   .size = 8,  {.data = &macro_double}   },
    { .id = "custom", .type = TYPE_CUSTOM,   .size = 12, {.data = &macro_trifloat} },

    { .id = "arr_char",   .type = TYPE_CHAR,     .size = sizeof(macro_char_arr),     {.data = &macro_char_arr}     },
    { .id = "arr_int8",   .type = TYPE_INT8,     .size = sizeof(macro_int8_arr),     {.data = &macro_int8_arr}     },
    { .id = "arr_int16",  .type = TYPE_INT16,    .size = sizeof(macro_int16_arr),    {.data = &macro_int16_arr}    },
    { .id = "arr_int32",  .type = TYPE_INT32,    .size = sizeof(macro_int32_arr),    {.data = &macro_int32_arr}    },
    { .id = "arr_uint8",  .type = TYPE_UINT8,    .size = sizeof(macro_uint8_arr),    {.data = &macro_uint8_arr}    },
    { .id = "arr_uint16", .type = TYPE_UINT16,   .size = sizeof(macro_uint16_arr),   {.data = &macro_uint16_arr}   },
    { .id = "arr_uint32", .type = TYPE_UINT32,   .size = sizeof(macro_uint32_arr),   {.data = &macro_uint32_arr}   },
    { .id = "arr_float",  .type = TYPE_FLOAT,    .size = sizeof(macro_float_arr),    {.data = &macro_float_arr}    },
    { .id = "arr_double", .type = TYPE_DOUBLE,   .size = sizeof(macro_double_arr),   {.data = &macro_double_arr}   },
    { .id = "arr_custom", .type = TYPE_CUSTOM,   .size = sizeof(macro_trifloat),     {.data = &macro_trifloat}     },
};

eui_message_t expected_object_array_read_only[] = {
    { .id = "char",   .type = TYPE_CHAR|READ_ONLY_MASK,      .size = 1,  {.data = &macro_char}     },
    { .id = "int8",   .type = TYPE_INT8|READ_ONLY_MASK,      .size = 1,  {.data = &macro_int8}     },
    { .id = "int16",  .type = TYPE_INT16|READ_ONLY_MASK,     .size = 2,  {.data = &macro_int16}    },
    { .id = "int32",  .type = TYPE_INT32|READ_ONLY_MASK,     .size = 4,  {.data = &macro_int32}    },
    { .id = "uint8",  .type = TYPE_UINT8|READ_ONLY_MASK,     .size = 1,  {.data = &macro_uint8}    },
    { .id = "uint16", .type = TYPE_UINT16|READ_ONLY_MASK,    .size = 2,  {.data = &macro_uint16}   },
    { .id = "uint32", .type = TYPE_UINT32|READ_ONLY_MASK,    .size = 4,  {.data = &macro_uint32}   },
    { .id = "float",  .type = TYPE_FLOAT|READ_ONLY_MASK,     .size = 4,  {.data = &macro_float}    },
    { .id = "double", .type = TYPE_DOUBLE|READ_ONLY_MASK,    .size = 8,  {.data = &macro_double}   },
    { .id = "custom", .type = TYPE_CUSTOM|READ_ONLY_MASK,    .size = 12, {.data = &macro_trifloat} },

    { .id = "arr_char",   .type = TYPE_CHAR|READ_ONLY_MASK,  .size = sizeof(macro_char_arr),     {.data = &macro_char_arr}     },
    { .id = "arr_int8",   .type = TYPE_INT8|READ_ONLY_MASK,  .size = sizeof(macro_int8_arr),     {.data = &macro_int8_arr}     },
    { .id = "arr_int16",  .type = TYPE_INT16|READ_ONLY_MASK, .size = sizeof(macro_int16_arr),    {.data = &macro_int16_arr}    },
    { .id = "arr_int32",  .type = TYPE_INT32|READ_ONLY_MASK, .size = sizeof(macro_int32_arr),    {.data = &macro_int32_arr}    },
    { .id = "arr_uint8",  .type = TYPE_UINT8|READ_ONLY_MASK, .size = sizeof(macro_uint8_arr),    {.data = &macro_uint8_arr}    },
    { .id = "arr_uint16", .type = TYPE_UINT16|READ_ONLY_MASK,.size = sizeof(macro_uint16_arr),   {.data = &macro_uint16_arr}   },
    { .id = "arr_uint32", .type = TYPE_UINT32|READ_ONLY_MASK,.size = sizeof(macro_uint32_arr),   {.data = &macro_uint32_arr}   },
    { .id = "arr_float",  .type = TYPE_FLOAT|READ_ONLY_MASK, .size = sizeof(macro_float_arr),    {.data = &macro_float_arr}    },
    { .id = "arr_double", .type = TYPE_DOUBLE|READ_ONLY_MASK,.size = sizeof(macro_double_arr),   {.data = &macro_double_arr}   },
    { .id = "arr_custom", .type = TYPE_CUSTOM|READ_ONLY_MASK,.size = sizeof(macro_trifloat),     {.data = &macro_trifloat}     },
};
