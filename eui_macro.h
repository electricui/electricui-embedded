...
#define EUI_CHAR_RO(   ID, DATA ) { .msgID = ID, .type = TYPE_CHAR|READ_ONLY_MASK,   .size = sizeof(DATA), .payload = &DATA }
#define EUI_INT8_RO(   ID, DATA ) { .msgID = ID, .type = TYPE_INT8|READ_ONLY_MASK,   .size = sizeof(DATA), .payload = &DATA }
#define EUI_INT16_RO(  ID, DATA ) { .msgID = ID, .type = TYPE_INT16|READ_ONLY_MASK,  .size = sizeof(DATA), .payload = &DATA }
#define EUI_INT32_RO(  ID, DATA ) { .msgID = ID, .type = TYPE_INT32|READ_ONLY_MASK,  .size = sizeof(DATA), .payload = &DATA }
#define EUI_UINT8_RO(  ID, DATA ) { .msgID = ID, .type = TYPE_UINT8|READ_ONLY_MASK,  .size = sizeof(DATA), .payload = &DATA }
#define EUI_UINT16_RO( ID, DATA ) { .msgID = ID, .type = TYPE_UINT16|READ_ONLY_MASK, .size = sizeof(DATA), .payload = &DATA }
#define EUI_UINT32_RO( ID, DATA ) { .msgID = ID, .type = TYPE_UINT32|READ_ONLY_MASK, .size = sizeof(DATA), .payload = &DATA }
#define EUI_FLOAT_RO(  ID, DATA ) { .msgID = ID, .type = TYPE_FLOAT|READ_ONLY_MASK,  .size = sizeof(DATA), .payload = &DATA }
#define EUI_DOUBLE_RO( ID, DATA ) { .msgID = ID, .type = TYPE_DOUBLE|READ_ONLY_MASK, .size = sizeof(DATA), .payload = &DATA }
