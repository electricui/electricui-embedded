...
eui_message_t expected_object_array[] = {
    ...
    { .msgID = "char",   .type = TYPE_CHAR,     .size = 1,  .payload = &macro_char      },
    { .msgID = "int8",   .type = TYPE_INT8,     .size = 1,  .payload = &macro_int8      },
    { .msgID = "int16",  .type = TYPE_INT16,    .size = 2,  .payload = &macro_int16     },
    { .msgID = "int32",  .type = TYPE_INT32,    .size = 4,  .payload = &macro_int32     },
    { .msgID = "uint8",  .type = TYPE_UINT8,    .size = 1,  .payload = &macro_uint8     },
    { .msgID = "uint16", .type = TYPE_UINT16,   .size = 2,  .payload = &macro_uint16    },
    { .msgID = "uint32", .type = TYPE_UINT32,   .size = 4,  .payload = &macro_uint32    },
    { .msgID = "float",  .type = TYPE_FLOAT,    .size = 4,  .payload = &macro_float     },
    { .msgID = "double", .type = TYPE_DOUBLE,   .size = 8,  .payload = &macro_double    },
    { .msgID = "custom", .type = TYPE_CUSTOM,   .size = 12, .payload = &macro_trifloat  },

    { .msgID = "arr_char",   .type = TYPE_CHAR,     .size = sizeof(macro_char_arr),     .payload = &macro_char_arr      },
    { .msgID = "arr_int8",   .type = TYPE_INT8,     .size = sizeof(macro_int8_arr),     .payload = &macro_int8_arr      },
    { .msgID = "arr_int16",  .type = TYPE_INT16,    .size = sizeof(macro_int16_arr),    .payload = &macro_int16_arr     },
    { .msgID = "arr_int32",  .type = TYPE_INT32,    .size = sizeof(macro_int32_arr),    .payload = &macro_int32_arr     },
    { .msgID = "arr_uint8",  .type = TYPE_UINT8,    .size = sizeof(macro_uint8_arr),    .payload = &macro_uint8_arr     },
    { .msgID = "arr_uint16", .type = TYPE_UINT16,   .size = sizeof(macro_uint16_arr),   .payload = &macro_uint16_arr    },
    { .msgID = "arr_uint32", .type = TYPE_UINT32,   .size = sizeof(macro_uint32_arr),   .payload = &macro_uint32_arr    },
    { .msgID = "arr_float",  .type = TYPE_FLOAT,    .size = sizeof(macro_float_arr),    .payload = &macro_float_arr     },
    { .msgID = "arr_double", .type = TYPE_DOUBLE,   .size = sizeof(macro_double_arr),   .payload = &macro_double_arr    },
    { .msgID = "arr_custom", .type = TYPE_CUSTOM,   .size = sizeof(macro_trifloat),     .payload = &macro_trifloat      },
};

eui_message_t expected_object_array_read_only[] = {
    { .msgID = "char",   .type = TYPE_CHAR|READ_ONLY_MASK,      .size = 1,  .payload = &macro_char      },
    { .msgID = "int8",   .type = TYPE_INT8|READ_ONLY_MASK,      .size = 1,  .payload = &macro_int8      },
    { .msgID = "int16",  .type = TYPE_INT16|READ_ONLY_MASK,     .size = 2,  .payload = &macro_int16     },
    { .msgID = "int32",  .type = TYPE_INT32|READ_ONLY_MASK,     .size = 4,  .payload = &macro_int32     },
    { .msgID = "uint8",  .type = TYPE_UINT8|READ_ONLY_MASK,     .size = 1,  .payload = &macro_uint8     },
    { .msgID = "uint16", .type = TYPE_UINT16|READ_ONLY_MASK,    .size = 2,  .payload = &macro_uint16    },
    { .msgID = "uint32", .type = TYPE_UINT32|READ_ONLY_MASK,    .size = 4,  .payload = &macro_uint32    },
    { .msgID = "float",  .type = TYPE_FLOAT|READ_ONLY_MASK,     .size = 4,  .payload = &macro_float     },
    { .msgID = "double", .type = TYPE_DOUBLE|READ_ONLY_MASK,    .size = 8,  .payload = &macro_double    },
    { .msgID = "custom", .type = TYPE_CUSTOM|READ_ONLY_MASK,    .size = 12, .payload = &macro_trifloat  },

    { .msgID = "arr_char",   .type = TYPE_CHAR|READ_ONLY_MASK,  .size = sizeof(macro_char_arr),     .payload = &macro_char_arr      },
    { .msgID = "arr_int8",   .type = TYPE_INT8|READ_ONLY_MASK,  .size = sizeof(macro_int8_arr),     .payload = &macro_int8_arr      },
    { .msgID = "arr_int16",  .type = TYPE_INT16|READ_ONLY_MASK, .size = sizeof(macro_int16_arr),    .payload = &macro_int16_arr     },
    { .msgID = "arr_int32",  .type = TYPE_INT32|READ_ONLY_MASK, .size = sizeof(macro_int32_arr),    .payload = &macro_int32_arr     },
    { .msgID = "arr_uint8",  .type = TYPE_UINT8|READ_ONLY_MASK, .size = sizeof(macro_uint8_arr),    .payload = &macro_uint8_arr     },
    { .msgID = "arr_uint16", .type = TYPE_UINT16|READ_ONLY_MASK,.size = sizeof(macro_uint16_arr),   .payload = &macro_uint16_arr    },
    { .msgID = "arr_uint32", .type = TYPE_UINT32|READ_ONLY_MASK,.size = sizeof(macro_uint32_arr),   .payload = &macro_uint32_arr    },
    { .msgID = "arr_float",  .type = TYPE_FLOAT|READ_ONLY_MASK, .size = sizeof(macro_float_arr),    .payload = &macro_float_arr     },
    { .msgID = "arr_double", .type = TYPE_DOUBLE|READ_ONLY_MASK,.size = sizeof(macro_double_arr),   .payload = &macro_double_arr    },
    { .msgID = "arr_custom", .type = TYPE_CUSTOM|READ_ONLY_MASK,.size = sizeof(macro_trifloat),     .payload = &macro_trifloat      },
};
